...
public class ZonedDateTimeTest {
    @Test
    public void test_LocalDateTime_atZone() {
    ...
    @Test
    public void test_ZonedDateTime_withZoneSameInstant() {
        LocalDateTime localDateTime = LocalDateTime.of(2022, 1, 1, 0, 30, 22);
    ...
    @Test
    public void test_ZonedDateTime_of() {
    ...
    @Test
    public void test_ZonedDateTime_ofInstant() {
    ...
    @Test
    public void test_ZonedDateTime_ofLocal() {
    ...
    @Test
    public void test_ZonedDateTime_ofStrict() {
        ...
        assertEquals("2022-12-25T06:18:02+09:00[Asia/Tokyo]", zonedDateTime.toString());

        zoneId = ZoneId.of("Asia/Tokyo");
        zoneOffset = ZoneOffset.UTC;
        ZoneOffset finalZoneOffset = zoneOffset;
        ZoneId finalZoneId = zoneId;
        assertThrows(DateTimeException.class, () -> ZonedDateTime.ofStrict(localDateTime, finalZoneOffset, finalZoneId));
    }

    @Test
    public void test_ZonedDateTime_toLocalDateTime() {
